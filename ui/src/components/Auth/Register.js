...
const Register = () => {
  ...
  const registerAttempt = async (data) => {
    try {
      setLoading(true);
      const error = await signup(data.username, data.password, data.email, data.first_name, data.last_name);
      if (error) {
          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-primary text-center shadow-dark border-radius-lg pt-4 pb-3">
                <h6 className="text-white ps-3 text-uppercase letter-spacing-4">Register new user</h6>
              </div>
            </div>
            <div className="card-body">
              <form role="form" className="text-start" onSubmit={handleSubmit(registerAttempt)} autoComplete="off">
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.username ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.email ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.password ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.passwordConfirm ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.first_name ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.last_name ? "is-invalid is-filled" : null}`}>
                ...
                <div className={`input-group input-group-outline mb-3 mt-2 ${errors.phone_number ? "is-invalid is-filled" : null}`}>
